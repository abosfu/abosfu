...
I build decision tools that turn messy signals into **scores, roadmaps, and next steps**.

---

## Now
- Building **decision systems** at the intersection of engineering + product.
- Shipping portfolio case studies and tightening real-world workflows.

## Focus
- **Machine Learning** (classification, evaluation, reproducible pipelines)
- **AI / Automation** (signal ingestion → scoring → report artifacts)
- **Data Systems** (scraping → datasets → rankings/recommendations)
- **Product Strategy** (UX research, service blueprinting, grounded proposals)
...
## Links
- Portfolio: https://abosfu.github.io/
- GitHub: https://github.com/abosfu
- LinkedIn: https://www.linkedin.com/in/abdullah-bin-omer-619124230/
- Contact: abo4@sfu.ca
